 ...
 * =====================================================================================
 *
 *       Filename:  test_column_major_layout.h
 *
 *    Description:  
 *
...
#ifndef  test_column_major_layout_INC
#define  test_column_major_layout_INC
...
// ===  function  ======================================================================
//         name:  verify_valid_2d_column_major_layout
//
//  description:  Validates the matrix in_ptr has a column major layout. Each 
//                matrix element in_ptr[jp][ip] = pairing_function(ip,jp). The elements
...
//                the corrsponding column major element associated with "disp" from the 
//                [0][0] element. For the in_ptr[jp][ip] element, disp = ip*column_size + jp.
//
//
...
verify_valid_2d_column_major_layout( const std::size_t row_size,
...
// ===  function  ======================================================================
//         name:  test_column_major_layout
//  description:  runs tests verfying a column major layout.
// =====================================================================================
void test_column_major_layout();


// ===  FUNCTION  ======================================================================
//         Name:  get_test_column_log_file_name
//  Description:  Returns the file name to which the tests results are wriiten to.
// =====================================================================================
std::string get_test_column_major_layout_logfile_name();


#endif   /* ----- #ifndef test_column_major_layout_INC  ----- */
