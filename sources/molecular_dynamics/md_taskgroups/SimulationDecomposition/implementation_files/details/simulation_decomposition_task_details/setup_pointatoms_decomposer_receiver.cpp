...
void setup_pointatoms_decomposer_receiver(
  ...
  using my_abstract_tasks =
      SimulationDecompositionTaskTraits::abstract_products; // The abstract task
                                                            // typelist.
  using my_concrete_tasks =
      SimulationDecompositionTaskTraits::concrete_products; // The concrete
                                                            // tasks typelist.
  ...
  //
  // ---------------------------------------------------
  auto concrete_task_factory = std::make_unique<
      GenericTaskFactory<my_abstract_tasks, my_concrete_tasks>>();
  ...
  //
  // ---------------------------------------------------
  using base_receiver_t =
      ANANSI::PointAtomsDecomposer::MyParentTask; // The base class for the task
                                                  // we are setting up.
  using concrete_receiver_t =
      ANANSI::PointAtomsDecomposer; // The concrete tasks we are setting up.
  ...
  // ---------------------------------------------------
  auto point_atoms_decomposer_reciver =
  ...
  std::shared_ptr<ANANSI::AnansiTask> my_task =
      concrete_task_factory->create_shared_ptr<base_receiver_t>(
          point_atoms_decomposer_reciver);
