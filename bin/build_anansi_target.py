...
def _create_target_architecture_directories():
    ...
    directories_to_create = ( os.path.join(anansi_top_level,anansi_target_architecture,'etc'),
                              os.path.join(anansi_top_level,anansi_target_architecture,'build'),
                              os.path.join(anansi_top_level,anansi_target_architecture,'configuration'),
                              os.path.join(anansi_top_level,anansi_target_architecture,'documentation'),
                              os.path.join(anansi_top_level,anansi_target_architecture,'umit_test_logs') )
