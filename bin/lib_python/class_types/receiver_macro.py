...
class FileGenerator:
    ...
    def __call__(self):
        ...
        self._createMacroReceiverFile()

        self._createMacroReceiverResultsTraitsFile()

        self._createMacroResultsOwnershipImplFile()

        return

    def _createMacroReceiverFile(self):
        ...
        preprocessor_name = self.namespace + "_" + receiverclassname + "_INC"
    ...
    def _createMacroReceiverResultsTraitsFile(self):
        (traits_header_file_name, traits_impl_file_name) = self.results_trait_files()
    ...
    def _createMacroResultsOwnershipImplFile(self):
        (ownershipimpl_header_file_name, ownershipimpl_impl_file_name) = self.results_ownership_impl_files()
